...
public class ReadXml {
	...
	private static GogeLogger log = GogeLogger.getLogger(ReadXml.class);
	

	/**
	 * 获取某包下（包括该包的所有子包）所有xml
	 *
	 * @param packageName
	 *            包名
	 * @return xml的完整名称
	 ...
	 */
	public static Set<String> loadXmlList(String packageName) throws IOException {
		if(packageName == null) {
			return new LinkedHashSet<>();
		}
		return getXmls(packageName);
	}
	 ...
	 * @return set
	 */
	private static Set<String> getXmls(String pack) {
